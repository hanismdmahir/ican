...
class ListResourceAvailable extends StatefulWidget {
  @override
  _ListResourceAvailableState createState() => _ListResourceAvailableState();
}

class _ListResourceAvailableState extends State<ListResourceAvailable> {
  final FirebaseAuth auth = FirebaseAuth.instance;
  List<ResourcesModel> resourcesList = [];
  _ListResourceAvailableState();
